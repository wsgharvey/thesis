...
\begin{table}[ht]
     \centering
   \caption{The 10 conditional molecule generation tasks used for evaluation in \cref{ch:tddm}. The number of each atom type required for the task is given in columns $2-5$ whilst the average number of atoms in molecules that meet this condition in the training dataset is given in the $6$th column.}
