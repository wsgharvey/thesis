\chapter{Supporting Materials for Flexible Diffusion Modeling of Long Videos}
...
%      & GQN-Mazes  & MineRL  \\
%     \hline
%     \multirow{1}{*}{FDM w/ uniform task distribution}     & $279$          & $902$       \\
%     \multirow{1}{*}{FDM}  & $235$          & $586$    \\
%     \bottomrule
%   \end{tabular}
%   \vspace{-1em}
% \end{table*}
...
\section{Relative position encodings}
