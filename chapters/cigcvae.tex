...
% \section{Motivation for Adapting Unconditional VAEs into Flexible VAEs}
...
% We will begin this chapter with a review of background material on variational auto-encoders and their hierarchical and conditional variants.
...
\section{Method: Inference in a Pretrained Artifact}
...
\subsubsection{Faster training with a pretrained VAE}
...
\subsection{Experiments} \label{sec:cigcvae-experiments}
