...
compare against four baselines from the literature: Co-Modulated Generative Adversarial Networks
...
We provide an additional demonstration of IPA on two image-to-image translation datasets, Edges2Shoes and
Edges2Handbags~\citep{isola2016image}, where the task is to generate an
...
\begin{figure}[t]
  ...
  \begin{minipage}{.4\textwidth}
    \centering
    \includegraphics[scale=.73]{figs/cigcvae/boed-auroc-curve-rearranged}
  \end{minipage}
  ~
  \begin{minipage}{0.54\textwidth}
    \centering
    \includegraphics[scale=.72]{figs/cigcvae/shrunk-boed-vis}
  \end{minipage}
