...
\end{align}
\Cref{eq:diffusion-integral-dsnr} leads to the interpretation of the diffusion loss shown in TODO. We can obtain an unbiased estimate of the integral in \cref{eq:difusion-elbo} with importance sampling from a proposal distribution $q(\sigma)$: 
\begin{align}
