...
\end{enumerate}
In particular, some of \cref{ch:conditional-diffusion} was previously published in \cref{harvey2023visual}; \cref{ch:fdm} is based on \cref{harvey2022flexible}; and \cref{ch:cigcvae} is based on \cref{harvey2021conditional}. \Cref{ch:conclusion} contains some text from each of \cref{harvey2022flexible,harvey2021conditional}.
