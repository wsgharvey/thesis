...
\title{Conditional generation and inference with deep generative models}
...
%% files
\hypersetup{
  pdftitle={Conditional generation and inference with deep generative models},
