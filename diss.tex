...
% some thesis-specific commands
\newcommand{\preds}{\hat{\rvs}}
\newcommand{\predx}{\hat{\rvx}}
\newcommand{\prede}{\hat{\mathbf{\epsilon}}}
...
% Define a new format for appendix chapters
\usepackage{titlesec}
...
% \newcommand{\titletext}{
%     % Flexible Generative Models of Images and Video
%     Flexible Conditioning in Generative Models of Images and Video
% }

\title{Flexible Conditioning in Generative Models \\ of Images and Video}
...
%% files
\hypersetup{
  pdftitle={Flexible Conditioning in Generative Models of Images and Video},
...
\include{chapters/conditional-diffusion}
\include{chapters/flexible-diffusion}
\include{chapters/fdm}
\include{chapters/tddm}
\include{chapters/cigcvae}
